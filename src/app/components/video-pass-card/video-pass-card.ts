...
import { lucideArrowRight, lucideCalendar, lucideExternalLink, lucideMapPin, lucidePause, lucidePin, lucidePlay } from '@ng-icons/lucide';
import { VideoPlayer } from "../video-player/video-player";
import { HlmIcon } from "@spartan-ng/helm/icon";
import { HlmBadge, HlmBadgeImports } from "@spartan-ng/helm/badge";
...
@Component({
  ...
  providers: [provideIcons({lucidePause, lucidePlay, lucideMapPin, lucideCalendar, lucideArrowRight})]
})
export class VideoPassCard {
  ...
  get speed() {
    return BoatSpeedLabel[this.pass.speed]
  }
